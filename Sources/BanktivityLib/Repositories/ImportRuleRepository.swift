...
public final class ImportRuleRepository: BaseRepository, @unchecked Sendable {
    ...
    public func match(description: String) throws -> [ImportRuleDTO] {
    ...
    public func create(templateId: Int, pattern: String, accountId: String? = nil, payee: String? = nil) throws -> ImportRuleDTO {
    ...
    public func update(ruleId: Int, pattern: String? = nil, accountId: String? = nil) throws -> Bool {
    ...
    public func delete(ruleId: Int) throws -> Bool {
        try performWriteReturning { [self] ctx in
            guard let rule = try fetchByPK(entityName: "ImportSourceTemplateSelector", pk: ruleId, in: ctx) else {
                return false
            }
    ...
    public func mapToDTO(_ object: NSManagedObject) throws -> ImportRuleDTO? {
