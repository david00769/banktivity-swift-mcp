...
public enum CapabilityRegistry {
    ...
    public static func cliCapabilities() -> [CommandCapabilityDTO] {
        [
            ...
            readCLI("securities holdings", note: "Aggregate cost basis is best-effort and not lot-aware. For lot-level basis and realised gains, use 'securities realized-gains'."),
            readCLI("securities trades"),
            readCLI("securities realized-gains", note: "Recomputes realised gains by FIFO lot matching -- Banktivity persists none. Dates filter the disposal. Refuses on a cost-basis method other than FIFO rather than reporting figures it has not been validated against."),
    ...
    public static func mcpCapabilities() -> [CommandCapabilityDTO] {
        [
            ...
            readMCP("get_security_holdings", note: "Aggregate cost basis is best-effort and not lot-aware. For lot-level basis and realised gains, use 'get_security_realized_gains'."),
            readMCP("get_security_trades"),
            readMCP("get_security_realized_gains", note: "Recomputes realised gains by FIFO lot matching -- Banktivity persists none. Dates filter the disposal. Refuses on a cost-basis method other than FIFO."),
