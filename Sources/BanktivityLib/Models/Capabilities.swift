...
public enum CapabilityRegistry {
    ...
    public static func cliCapabilities() -> [CommandCapabilityDTO] {
        [
            ...
            verifiedWriteCLI("line-items add", note: "Line-item writes affect balances and statement membership; a follow-up safety PR should add explicit confirmation flags."),
            verifiedWriteCLI("line-items update", note: "Line-item writes affect balances and statement membership; a follow-up safety PR should add explicit confirmation flags."),
            verifiedWriteCLI("line-items delete", note: "Line-item writes affect balances and statement membership; a follow-up safety PR should add explicit confirmation flags."),
            ...
            writeCLI("statements delete", confirmations: ["backup_confirmed", "post_ui_verification_required"], uiVerificationRequired: true),
    ...
    public static func mcpCapabilities() -> [CommandCapabilityDTO] {
        [
            ...
            verifiedWriteMCP("add_line_item", note: "Line-item writes affect balances and statement membership; a follow-up safety PR should add explicit confirmation arguments."),
            verifiedWriteMCP("update_line_item", note: "Line-item writes affect balances and statement membership; a follow-up safety PR should add explicit confirmation arguments."),
            verifiedWriteMCP("delete_line_item", note: "Line-item writes affect balances and statement membership; a follow-up safety PR should add explicit confirmation arguments."),
            ...
            writeMCP("delete_statement", confirmations: ["backup_confirmed", "post_ui_verification_required"], uiVerificationRequired: true),
    ...
    private static func verifiedWriteCLI(_ name: String, note: String) -> CommandCapabilityDTO {
    ...
    private static func verifiedWriteMCP(_ name: String, note: String) -> CommandCapabilityDTO {
